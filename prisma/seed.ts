    ...
    const products = [
      {
        ...
        prdSalePrc: null,
        prdCtgrCd: "CERAMICS",
        prdImgUrl: "https://images.unsplash.com/photo-1612196808214-b8e1d6145a8c?w=600&h=600&fit=crop",
        prdImgUrls: ["https://images.unsplash.com/photo-1612196808214-b8e1d6145a8c?w=600&h=600&fit=crop", "https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?w=600&h=600&fit=crop"],
        stckQty: 12,
        soldCnt: 142,
        viewCnt: 2840,
        avgRtng: 4.8,
      ...
      },
      {
        ...
        prdSalePrc: 48.00,
        prdCtgrCd: "TEXTILES",
        prdImgUrl: "https://images.unsplash.com/photo-1616046229478-9901c5536a45?w=600&h=600&fit=crop",
        prdImgUrls: ["https://images.unsplash.com/photo-1616046229478-9901c5536a45?w=600&h=600&fit=crop", "https://images.unsplash.com/photo-1597696929736-6d13bed8e6a8?w=600&h=600&fit=crop"],
        stckQty: 35,
        soldCnt: 98,
        viewCnt: 1920,
        avgRtng: 4.6,
      ...
      },
      {
        ...
        prdSalePrc: null,
        prdCtgrCd: "CERAMICS",
        prdImgUrl: "https://images.unsplash.com/photo-1514228742587-6b1558fcca3d?w=600&h=600&fit=crop",
        prdImgUrls: ["https://images.unsplash.com/photo-1514228742587-6b1558fcca3d?w=600&h=600&fit=crop", "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=600&h=600&fit=crop"],
        stckQty: 8,
        soldCnt: 87,
        viewCnt: 1650,
        avgRtng: 4.9,
      ...
      },
      {
        ...
        prdSalePrc: null,
        prdCtgrCd: "ART",
        prdImgUrl: "https://images.unsplash.com/photo-1459411552884-841db9b3cc2a?w=600&h=600&fit=crop",
        prdImgUrls: ["https://images.unsplash.com/photo-1459411552884-841db9b3cc2a?w=600&h=600&fit=crop"],
        stckQty: 50,
        soldCnt: 76,
        viewCnt: 1280,
        avgRtng: 4.7,
      ...
      },
      {
        ...
        prdSalePrc: 62.00,
        prdCtgrCd: "TEXTILES",
        prdImgUrl: "https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=600&h=600&fit=crop",
        prdImgUrls: ["https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=600&h=600&fit=crop", "https://images.unsplash.com/photo-1601924921557-45e8c1c72ff6?w=600&h=600&fit=crop"],
        stckQty: 20,
        soldCnt: 65,
        viewCnt: 980,
        avgRtng: 4.5,
      ...
      },
      {
        ...
        prdSalePrc: null,
        prdCtgrCd: "ART",
        prdImgUrl: "https://images.unsplash.com/photo-1547891654-e66ed7ebb968?w=600&h=600&fit=crop",
        prdImgUrls: ["https://images.unsplash.com/photo-1547891654-e66ed7ebb968?w=600&h=600&fit=crop"],
        stckQty: 1,
        soldCnt: 12,
        viewCnt: 890,
        avgRtng: 5.0,
      ...
      },
      {
        ...
        prdSalePrc: 128.00,
        prdCtgrCd: "CERAMICS",
        prdImgUrl: "https://images.unsplash.com/photo-1603199506016-5f36e6d72b0e?w=600&h=600&fit=crop",
        prdImgUrls: ["https://images.unsplash.com/photo-1603199506016-5f36e6d72b0e?w=600&h=600&fit=crop", "https://images.unsplash.com/photo-1578749556568-bc2c40e68b61?w=600&h=600&fit=crop"],
        stckQty: 15,
        soldCnt: 54,
        viewCnt: 1120,
        avgRtng: 4.7,
      ...
      },
      {
        ...
        prdSalePrc: null,
        prdCtgrCd: "ART",
        prdImgUrl: "https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?w=600&h=600&fit=crop",
        prdImgUrls: ["https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?w=600&h=600&fit=crop"],
        stckQty: 40,
        soldCnt: 118,
        viewCnt: 2100,
        avgRtng: 4.4,
      ...
      },
      {
        ...
        prdSalePrc: null,
        prdCtgrCd: "TEXTILES",
        prdImgUrl: "https://images.unsplash.com/photo-1580301762395-21ce6d5d4bc4?w=600&h=600&fit=crop",
        prdImgUrls: ["https://images.unsplash.com/photo-1580301762395-21ce6d5d4bc4?w=600&h=600&fit=crop", "https://images.unsplash.com/photo-1543294001-f7cd5d7fb516?w=600&h=600&fit=crop"],
        stckQty: 10,
        soldCnt: 33,
        viewCnt: 760,
        avgRtng: 4.8,
      ...
      },
      {
        ...
        prdSalePrc: null,
        prdCtgrCd: "HOME",
        prdImgUrl: "https://images.unsplash.com/photo-1602028915047-37269d1a73f7?w=600&h=600&fit=crop",
        prdImgUrls: ["https://images.unsplash.com/photo-1602028915047-37269d1a73f7?w=600&h=600&fit=crop"],
        stckQty: 25,
        soldCnt: 201,
        viewCnt: 3200,
        avgRtng: 4.6,
      ...
      },
      {
        ...
        prdSalePrc: null,
        prdCtgrCd: "TEXTILES",
        prdImgUrl: "https://images.unsplash.com/photo-1597633425046-08f5110420b5?w=600&h=600&fit=crop",
        prdImgUrls: ["https://images.unsplash.com/photo-1597633425046-08f5110420b5?w=600&h=600&fit=crop"],
        stckQty: 60,
        soldCnt: 245,
        viewCnt: 4100,
        avgRtng: 4.3,
      ...
      },
      {
        ...
        prdSalePrc: 45.00,
        prdCtgrCd: "ART",
        prdImgUrl: "https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=600&h=600&fit=crop",
        prdImgUrls: ["https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=600&h=600&fit=crop", "https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b?w=600&h=600&fit=crop"],
        stckQty: 30,
        soldCnt: 89,
        viewCnt: 1540,
        avgRtng: 4.9,
